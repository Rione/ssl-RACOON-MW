...
const file_ssl_gc_game_event_proto_rawDesc = "" +
	"\n" +
	"\x17ssl_gc_game_event.proto\x1a\x13ssl_gc_common.proto\x1a\x15ssl_gc_geometry.proto\"\xb4O\n" +
	"\tGameEvent\x12#\n" +
	"\x04type\x18( \x01(\x0e2\x0f.GameEvent.TypeR\x04type\x12\x16\n" +
	"\x06origin\x18) \x03(\tR\x06origin\x12V\n" +
	...
	"\x0echallenge_flag\x18. \x01(\v2\x18.GameEvent.ChallengeFlagH\x00R\rchallengeFlag\x12A\n" +
	...
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12$\n" +
	"\blocation\x18\x02 \x01(\v2\b.Vector2R\blocation\x1aY\n" +
	"\x11PenaltyKickFailed\x12\x1e\n" +
	"\aby_team\x18\x01 \x02(\x0e2\x05.TeamR\x06byTeam\x12$\n" +
	"\blocation\x18\x02 \x01(\v2\b.Vector2R\blocation\"\xe2\t\n" +
	"\x04Type\x12\x1b\n" +
	...
	"\x05eventB-Z+github.com/Rione-SSL/RACOON-Pi/proto/pb_gen"

var (
	file_ssl_gc_game_event_proto_rawDescOnce sync.Once
	file_ssl_gc_game_event_proto_rawDescData []byte
)

func file_ssl_gc_game_event_proto_rawDescGZIP() []byte {
	file_ssl_gc_game_event_proto_rawDescOnce.Do(func() {
		file_ssl_gc_game_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ssl_gc_game_event_proto_rawDesc), len(file_ssl_gc_game_event_proto_rawDesc)))
	})
...
func file_ssl_gc_game_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ssl_gc_game_event_proto_rawDesc), len(file_ssl_gc_game_event_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   39,
			NumExtensions: 0,
			NumServices:   0,
