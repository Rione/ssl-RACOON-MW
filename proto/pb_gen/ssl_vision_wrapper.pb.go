...
const file_ssl_vision_wrapper_proto_rawDesc = "" +
	"\n" +
	"\x18ssl_vision_wrapper.proto\x1a\x1assl_vision_detection.proto\x1a\x19ssl_vision_geometry.proto\"u\n" +
	"\x11SSL_WrapperPacket\x121\n" +
	"\tdetection\x18\x01 \x01(\v2\x13.SSL_DetectionFrameR\tdetection\x12-\n" +
	"\bgeometry\x18\x02 \x01(\v2\x11.SSL_GeometryDataR\bgeometryB-Z+github.com/Rione-SSL/RACOON-Pi/proto/pb_gen"

var (
	file_ssl_vision_wrapper_proto_rawDescOnce sync.Once
	file_ssl_vision_wrapper_proto_rawDescData []byte
)

func file_ssl_vision_wrapper_proto_rawDescGZIP() []byte {
	file_ssl_vision_wrapper_proto_rawDescOnce.Do(func() {
		file_ssl_vision_wrapper_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ssl_vision_wrapper_proto_rawDesc), len(file_ssl_vision_wrapper_proto_rawDesc)))
	})
...
func file_ssl_vision_wrapper_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ssl_vision_wrapper_proto_rawDesc), len(file_ssl_vision_wrapper_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
