...
const file_ssl_vision_detection_proto_rawDesc = "" +
	"\n" +
	...
	"robotsBlueB-Z+github.com/Rione-SSL/RACOON-Pi/proto/pb_gen"

var (
	file_ssl_vision_detection_proto_rawDescOnce sync.Once
	file_ssl_vision_detection_proto_rawDescData []byte
)

func file_ssl_vision_detection_proto_rawDescGZIP() []byte {
	file_ssl_vision_detection_proto_rawDescOnce.Do(func() {
		file_ssl_vision_detection_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ssl_vision_detection_proto_rawDesc), len(file_ssl_vision_detection_proto_rawDesc)))
	})
...
func file_ssl_vision_detection_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ssl_vision_detection_proto_rawDesc), len(file_ssl_vision_detection_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
